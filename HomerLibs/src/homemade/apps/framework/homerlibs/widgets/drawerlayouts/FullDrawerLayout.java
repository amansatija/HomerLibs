...
public class FullDrawerLayout extends homemade.apps.framework.homerlibs.widgets.drawerlayouts.DrawerLayout {
		...
		for (int i = 0; i < childCount; i++) {
			...
			if (isContentView(child)) {
				...
				final int drawerWidthSpec = getChildMeasureSpec(
						widthMeasureSpec, MIN_DRAWER_MARGIN + lp.leftMargin
